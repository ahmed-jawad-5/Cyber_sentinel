...
**Cyber Sentinel** is a real-time network traffic monitoring and analysis system that leverages **machine learning (XGBoost)** and **retrieval-augmented generation (RAG)** for anomaly detection.  
It captures network flows from a sender, sends them to a receiver, predicts their labels, and provides detailed AI-assisted explanations for anomalies.

---

## 🌟 Key Features

1. **📡 Real-time Packet Capture & Transmission**
...
5. **🛠️ Custom DB Using Data Structures**
...
3. **If anomaly, RAG generates reasoning:**
